...
import 'package:digital_store_flutter/logic/cubits/widget_cubits/see_product_page_cubit/see_product_page_cubit.dart';
import 'package:digital_store_flutter/ui/screens/see_product_page.dart';
        ...
        child: BlocBuilder<CartCubit, CartState>(
          ...
          builder: (context, state) {
            if (state is CartInitial) {
              ...
              if ((state as CartError).sessionEnded) {
                Future.delayed(
                  Duration.zero,
                  () async {
